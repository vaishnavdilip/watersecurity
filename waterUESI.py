...
# def cluster_waterStress(city):
#     city_df = df_water[df_water.cluster == df_water.loc[city]['cluster']]
#     tittleH = 'Density distribution water stress cluster ' + city
    
#     fig, ax = plt.subplots(1,1,figsize=(8,8))
#     city_df['WATSTRESS'].plot.kde(ax=ax, legend=False, title=tittleH)
#     city_df['WATSTRESS'].plot.hist(density=True, ax=ax)
#     ax.set_ylabel('Density', size = 15)
#     ax.set_xlabel('Water stress', size = 15)
#     ax.grid(axis='y')
#     plt.axvline(x=0.2, linestyle ="--")
#     plt.axvline(x=0.4, linestyle ="--")
#     plt.axvline(x=df_water.loc[city]['WATSTRESS'], c ='black')
#     ax.annotate('Moderate strees', xy=(0.25,1.5), ha='center', va='center', rotation=90, size = 15)
#     ax.annotate('High stress', xy=(0.45,1.5), ha='center', va='center', rotation=90, size = 15)
#     ax.annotate(city, xy=(df_water.loc[city]['WATSTRESS']+0.05,2), ha='center', va='center', rotation=90, c= 'blue', size = 15)
